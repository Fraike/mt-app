            ...
            <el-col :sapn="15" class="center">
                <div class="wrapper">
                    ...
                    <dl class="hotPlace" v-if="isHotPlace">
                        <dt>热门搜索</dt>
                        <dd v-for="(item,index) in this.$store.state.home.hotPlace.slice(0,5)" :key="index">{{item.name}}</dd>
                    </dl>
                ...
                <p class="suggest">
                    <a href="" v-for="(item,index) in this.$store.state.home.hotPlace.slice(0,5)" :key="index">
                        {{item.name}}
                    </a>
                </p>
                <ul class="nav">
